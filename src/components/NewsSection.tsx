      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-600 text-sm sm:text-base mt-1">
            {t('news.sectionSubtitle', '기억과 평화의 집의 생생한 사업 소식과 카드뉴스를 전해드립니다.')}
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  {/* Card Footer Meta */}
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-end text-xs text-slate-600">
                    <span className="text-teal-700 font-bold group-hover:translate-x-1 transition-transform flex items-center gap-0.5">
                      {t('news.readMore', '자세히 보기')} <ChevronRight className="w-4 h-4" />
                    </span>
                  </div>
                </div>
              </article>
        ...
        {selectedNews && (
          <div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md overflow-y-auto animate-fade-in cursor-pointer"
          >
            <div
              onClick={(e) => e.stopPropagation()}
              className="bg-white rounded-3xl max-w-3xl w-full overflow-hidden shadow-2xl border border-slate-200 relative my-8 cursor-default"
            >
              ...
              <div className="p-6 sm:p-8 space-y-6 max-h-[50vh] overflow-y-auto">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Author: {language === 'en' && selectedNews.authorEn ? selectedNews.authorEn : selectedNews.author}
                  </p>
                </div>
                ...
                {selectedNews.externalLink && (
                  <div className="bg-gradient-to-r from-red-50 to-rose-50 border border-red-200/90 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm">
                    ...
                    >
                      ...
                      <span>{t('news.watchStream', '방송 바로보기 (YouTube)')}</span>
